...
(function () {
  ...
  var THEMES = [
    ...
    { id: "suckless-dark", label: "极简暗色", swatch: "linear-gradient(135deg,#0d0d0d 50%,#e6e6e6 50%)" },
  ...
  var I18N = {
    ...
    "模型排行榜": { zh: "模型排行榜", en: "Leaderboards" },
    ...
    /* 排行榜页 */
    "大模型排行榜": { zh: "大模型排行榜", en: "LLM Leaderboards" },
    "聚合主流公开榜单：实际使用热度、综合能力与开源生态，每 30 分钟自动刷新。": {
      zh: "聚合主流公开榜单：实际使用热度、综合能力与开源生态，每 30 分钟自动刷新。",
      en: "Aggregated public leaderboards: real usage, capability and open-source ecosystem, auto-refreshed every 30 minutes."
    },
    "加载中…": { zh: "加载中…", en: "Loading…" },
    "快照不可用，稍后再试。": { zh: "快照不可用，稍后再试。", en: "Snapshot unavailable, try again later." },
    "模型": { zh: "模型", en: "Model" },
    "数值": { zh: "数值", en: "Value" },
    "暂无数据": { zh: "暂无数据", en: "No data" },
    "更新于": { zh: "更新于", en: "Updated" },
    "数据源": { zh: "数据源", en: "Source" },
    "同步于": { zh: "同步于", en: "Synced" },
    "前": { zh: "前", en: "ago" },
    "榜单数据来自公开源，仅供参考": { zh: "榜单数据来自公开源，仅供参考", en: "Leaderboard data from public sources, for reference only" },
    ...
    /* 对话页 */
    "新建对话": { zh: "新建对话", en: "New chat" },
    "搜索对话…": { zh: "搜索对话…", en: "Search chats…" },
    "暂无对话": { zh: "暂无对话", en: "No chats" },
    "打开会话列表": { zh: "打开会话列表", en: "Open chat list" },
    "给 DeepSeek 发消息": { zh: "给 DeepSeek 发消息", en: "Message DeepSeek" },
    "发送": { zh: "发送", en: "Send" },
    "停止": { zh: "停止", en: "Stop" },
    "深度思考": { zh: "深度思考", en: "Deep Think" },
    "联网搜索": { zh: "联网搜索", en: "Search web" },
    "你好，我是 AI SIGNAL，很高兴见到你 👋": { zh: "你好，我是 AI SIGNAL，很高兴见到你 👋", en: "Hi, I'm AI SIGNAL. Nice to meet you 👋" },
    "支持流式输出。Enter 发送，Shift+Enter 换行。": {
      zh: "支持流式输出。Enter 发送，Shift+Enter 换行。",
      en: "Streaming output. Enter to send, Shift+Enter for a newline."
    },
    "内容由第三方模型生成，请自行甄别 · 对话与密钥仅保存在本机浏览器": {
      zh: "内容由第三方模型生成，请自行甄别 · 对话与密钥仅保存在本机浏览器",
      en: "Content generated by third-party models · verify yourself · chats & keys stay in your browser"
    },
    "对话服务": { zh: "对话服务", en: "Service" },
    "设置": { zh: "设置", en: "Settings" },
    "保存": { zh: "保存", en: "Save" },
    "DeepSeek API": { zh: "DeepSeek API", en: "DeepSeek API" },
    "免费试用": { zh: "免费试用", en: "Free trial" },
    "无需注册，约 15 秒一次请求": { zh: "无需注册，约 15 秒一次请求", en: "No sign-up · ~1 request / 15s" },
    "填入你自己的 API Key，直连 api.deepseek.com": {
      zh: "填入你自己的 API Key，直连 api.deepseek.com",
      en: "Paste your own API Key; connects directly to api.deepseek.com"
    },
    "显示": { zh: "显示", en: "Show" },
    "隐藏": { zh: "隐藏", en: "Hide" },
    "密钥仅保存在本机浏览器 localStorage，请求直接发往 DeepSeek 官方接口，不经过本站服务器。可前往 platform.deepseek.com 获取。": {
      zh: "密钥仅保存在本机浏览器 localStorage，请求直接发往 DeepSeek 官方接口，不经过本站服务器。可前往 platform.deepseek.com 获取。",
      en: "Your key stays in local browser storage; requests go directly to DeepSeek's official API, never through our server. Get one at platform.deepseek.com."
    },
    "尚未设置 Key": { zh: "尚未设置 Key", en: "No key set" },
    "已保存：": { zh: "已保存：", en: "Saved: " },
    "已保存": { zh: "已保存", en: "Saved" },
    "本页为纯前端实现：免费模式由 Pollinations.ai 提供；API 模式直连 DeepSeek 官方接口。": {
      zh: "本页为纯前端实现：免费模式由 Pollinations.ai 提供；API 模式直连 DeepSeek 官方接口。",
      en: "Pure front-end page: free mode powered by Pollinations.ai; API mode connects directly to DeepSeek's official API."
    },
    "未设置 API Key，请点击左下角「设置」填写。": {
      zh: "未设置 API Key，请点击左下角「设置」填写。",
      en: "No API Key set. Open Settings (bottom-left) and paste your key."
    },
    "免费服务冷却中": { zh: "免费服务冷却中", en: "Free service cooling down" },
    "免费服务请求太频繁（429），已进入约 15 秒冷却。": {
      zh: "免费服务请求太频繁（429），已进入约 15 秒冷却。",
      en: "Free service rate-limited (429); cooldown ~15s."
    },
    "DeepSeek API 无余额或无权限（402），请前往 platform.deepseek.com 充值后重试。": {
      zh: "DeepSeek API 无余额或无权限（402），请前往 platform.deepseek.com 充值后重试。",
      en: "DeepSeek API: no balance or no permission (402). Top up at platform.deepseek.com and retry."
    },
    "API Key 无效（": { zh: "API Key 无效（", en: "Invalid API Key (" },
    "），请检查设置中的 Key。": { zh: "），请检查设置中的 Key。", en: "). Check the key in Settings." },
    "请求过于频繁（429），请稍后再试。": {
      zh: "请求过于频繁（429），请稍后再试。",
      en: "Too many requests (429). Try again shortly."
    },
    "请求失败（": { zh: "请求失败（", en: "Request failed (" },
    "当前浏览器不支持流式读取，请换用现代浏览器。": {
      zh: "当前浏览器不支持流式读取，请换用现代浏览器。",
      en: "This browser does not support streaming reads. Please use a modern browser."
    },
    "网络异常，请重试。": { zh: "网络异常，请重试。", en: "Network error. Please retry." },
    "已停止": { zh: "已停止", en: "Stopped" },
    "已开启深度思考（推理模式）": { zh: "已开启深度思考（推理模式）", en: "Deep Think on (reasoning mode)" },
    "已开启深度思考": { zh: "已开启深度思考", en: "Deep Think on" },
    "已关闭深度思考": { zh: "已关闭深度思考", en: "Deep Think off" },
    "已开启联网搜索（回答会结合 AI SIGNAL 站内最新资讯）": {
      zh: "已开启联网搜索（回答会结合 AI SIGNAL 站内最新资讯）",
      en: "Web search on (answers grounded in AI SIGNAL's latest snapshot)"
    },
    "已关闭联网搜索": { zh: "已关闭联网搜索", en: "Web search off" }
  };
